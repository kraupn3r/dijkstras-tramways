...
class Line(models.Model):
    ...
    first_stop = models.ForeignKey('tramstop', on_delete=models.PROTECT, related_name="startinglines", null = True)
    last_stop = models.ForeignKey('tramstop', on_delete=models.PROTECT, related_name="endinglines", null = True)
...
class StopTimetable(models.Model):
    line = models.ForeignKey(Line, on_delete=models.CASCADE, related_name='stoptables')
    stop = models.ForeignKey(TramStop, on_delete=models.CASCADE, related_name='stoptables')
...
class AdjacencyMatrixCell(models.Model):
    col = models.ForeignKey(TramStop, on_delete=models.CASCADE, related_name='colstop')
    row = models.ForeignKey(TramStop, on_delete=models.CASCADE, related_name='rowstop')
